...
function YesButton(props) {
  ...
  var btnStyle = {
    ...
    // borderStyle: 'dashed',
    // background: `${topColor}`,
    backgroundImage: "linear-gradient(rgba(".concat(props.topColor.color.r, ", ").concat(props.topColor.color.g, ", ").concat(props.topColor.color.b, ", ").concat(props.topColor.color.a, "), rgba(").concat(props.bottomColor.color.r, ", ").concat(props.bottomColor.color.g, ", ").concat(props.bottomColor.color.b, ", ").concat(props.bottomColor.color.a, ")")
  };
  var textStyle = {
...
//# sourceMappingURL=index.js.6b1ae2e78d2922593488.hot-update.js.map